...
- **Status:** epic 4A `in_progress`; decomposition (4A.1) `in_review`;
  4A.2–4A.8 `backlog`. **Next action: run 4A.2** (residual-target builder +
  `target_mode` loader flag, local). GPU stories (4A.4/4A.5) gated on
