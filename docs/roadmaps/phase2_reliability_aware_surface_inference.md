...
> harness (`done`), 2B.3 no-arbitrage diagnostics (`in_review` — calendar /
> monotonicity / convexity checks implemented + tested), 2B.4 risk-flag
> synthesis + region heatmaps, 2B.5 diagnostics runner + artifacts (2B.4–2B.5
