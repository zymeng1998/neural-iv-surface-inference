...
| 3X.11 | Story | Local: calibrator re-fit on OTM val predictions (mirror 3B.6) — → val cov 0.9000, T=1.005, ens_scale=1.91; val hi-conf MAE 0.00849 < no-abst 0.01349; test cov 0.866 (val→test drift > 3B.6 dirty) | `in_review` | `docs/tasks/specs/3X.11_local_calibration_on_otm.md` | 2026-06-02 |
