...
| 4A.4 | Story | Remote (GPU): train residual hybrid across heads {gaussian,quantile,point} on OTM (ANP-residual default; report summed σ̂ MAE vs RBF + 3X.9) — **hybrid BEATS RBF: gaussian 0.006006 / quantile 0.005906 vs RBF 0.006132 (point ties); all ≪ 3X.9** (significance → 4A.7) | `in_review` | `docs/tasks/specs/4A.4_remote_train_residual_hybrid.md` | 2026-06-20 |
