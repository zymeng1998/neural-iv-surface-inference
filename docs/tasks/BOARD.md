...
| 4A.1 | Story | Decompose Phase 4A + ADR 0010 + 4A.2–4A.8 specs | `in_review` | `docs/tasks/specs/4A.1_decompose_phase_4a.md` | 2026-06-18 |
| 4A.2 | Story | Local: residual-target builder + `target_mode ∈ {absolute, residual}` loader flag + unit/smoke tests (no full build/train) | `backlog` | `docs/tasks/specs/4A.2_residual_target_builder.md` | 2026-06-18 |
| 4A.3 | Story | Remote (CPU): build full residual-target dataset on OTM (per-date RBF at query coords → residuals) + finiteness/MAE-sanity audit | `backlog` | `docs/tasks/specs/4A.3_remote_build_residual_dataset.md` | 2026-06-18 |
| 4A.4 | Story | Remote (GPU): train residual hybrid across heads {gaussian,quantile,point} on OTM (ANP-residual default; report summed σ̂ MAE vs RBF + 3X.9) | `backlog` | `docs/tasks/specs/4A.4_remote_train_residual_hybrid.md` | 2026-06-18 |
| 4A.5 | Story | Remote (GPU): K=5 deep ensemble of residual point head (mirror 3X.10); disagreement for the calibrator | `backlog` | `docs/tasks/specs/4A.5_remote_residual_ensemble.md` | 2026-06-18 |
| 4A.6 | Story | Local: calibrator re-fit on hybrid val predictions (mirror 3X.11) | `backlog` | `docs/tasks/specs/4A.6_local_calibrator_refit_hybrid.md` | 2026-06-18 |
