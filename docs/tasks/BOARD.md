...
| 3B.4 | Story | Remote: full AV training of ANP across `head.kind ∈ {gaussian, quantile, point}` | `in_review` | `docs/tasks/specs/3B.4_remote_full_av_training.md` | 2026-05-28 |
