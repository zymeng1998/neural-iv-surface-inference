...
| 4A.5 | Story | Remote (GPU): K=5 deep ensemble of residual point head (mirror 3X.10); disagreement for the calibrator — ensemble test MAE 0.006141 (ties RBF, like 4A.4 single point); disagreement mean 0.000209 | `in_review` | `docs/tasks/specs/4A.5_remote_residual_ensemble.md` | 2026-06-20 |
