...
| 3C.3 | Story | Remote (GPU): full AV retrain of DeepSets+ANP with `feature_set: micro_v1` across `head.kind ∈ {gaussian, quantile, point}` on OTM (mirrors 3X.9). Ran; micro_v1 WORSE than 3X.9 on test MAE in all 3 heads (gauss 0.01634 / quant 0.01362 / point 0.01439 vs 0.01440 / 0.01175 / 0.00987) | `in_review` | `docs/tasks/specs/3C.3_remote_anp_micro_three_head.md` | 2026-06-03 |
