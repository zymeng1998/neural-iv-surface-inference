...
| 3X.12 | Story | Remote: decision-layer eval on OTM, thresholds held constant (Q2; mirror 3B.7) — → test MAE **0.01162** / hi-conf MAE **0.00835** / cov@0.90 **0.9295** / mean_width **0.0538** / abstain 1.0 / flag-viol **1814** (dirty 3B.7: 0.0813 / 0.0542 / 0.915 / 0.304 / 1.0 / 9007 — Q2 invariant held: thresholds unchanged) | `in_review` | `docs/tasks/specs/3X.12_remote_decision_layer_eval_on_otm.md` | 2026-06-02 |
