...
| 4A.2 | Story | Local: residual-target builder + `target_mode ∈ {absolute, residual}` loader flag + unit/smoke tests (no full build/train) — implemented: `residual_targets.py` reuses 3X.6 RBF; absolute byte-identical; 20 tests green | `in_review` | `docs/tasks/specs/4A.2_residual_target_builder.md` | 2026-06-18 |
